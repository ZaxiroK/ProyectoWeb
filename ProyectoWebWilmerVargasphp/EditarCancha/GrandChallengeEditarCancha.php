...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../EditarCancha/estilos.css">
  ...
  <body>
    ...
    <div class="my-content" >
        <div class="container" > 
            <div class="row">
                <div class="col-sm-12" >
                  <h1><strong>GrandChallenge</strong> Editar Cancha</h1>
                  <div class="mydescription">
                    <p>Edita tus servicios de alquiler de cancha</p>
                  ...
                  <!--
                    ...
                    <div class="myform-top">
                        <div class="myform-top-left">
                            ...
                            <h3>Por favor ingresa los nuevos datos de tu Cancha:</h3>
                        </div>
    ...
    <script src="https://maxcdn.bootstrapodn.com/bootstrap/3.3.4/bootstrap.min.ja"></script>  
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.ja"></script>
