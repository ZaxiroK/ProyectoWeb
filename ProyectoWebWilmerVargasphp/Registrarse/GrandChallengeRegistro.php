        ...
        <nav class = "navbar navbar-inverse navbar-stactic-top" role = "navigation">
            <div class = "container">
                ...
                <div class ="collapse navbar-collapse" id ="navegacion-Wil">
                    ...
                    <a href= "../PrincipalLogin/GrandChallengePrincipalLogin.php" class="btn btn-lg btn-primary navbar-right">Iniciar sesion</a>
                    ...
                    <div class="myform-bottom">
                      <form role="form" method="post" class="form-register" >
                        ...
                        <div class="form-group">
                            <input type="text" name="userName" placeholder="Nombre de usuario..." required class="form-control" id="form-user">
                        </div>
                        <div class="form-group"> 
                            <input type="text" name="name" placeholder="Primer nombre..." required class="form-control" id="form-firtsname">
                        </div>
                        <div class="form-group">
                            <input type="text" name="lastName" placeholder="Primer apellido..."  required class="form-control" id="form-lastname">
                        </div>
                          <div class="form-group">
                            
                            <input type="text" name="email" placeholder="Correo electronico" required class="form-control" id="form-email">
                        </div>
                        ...
                        <div class="form-group">
                            <input type="text" name="phone" placeholder="Telefono..." required class="form-control" id="form-phone">
                        </div>
                        ...
                        <div class="form-group">
                         ...
                         <!-- <a href="../Registrarse/GranChallengeRegistro.html" class="btn btn-lg btn-success" id="bntRegistrar" onclick="insert();">Registrarme</a> -->   
                          <a href ="../PrincipalLogin/GrandChallengePrincipalLogin.php" class= "btn btn-lg btn-default">Cancelar</a>      
