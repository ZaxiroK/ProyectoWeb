...
function validar() {
    var nombre, apellido,correo,tipoCuenta, genero, telefono, usuario, contrasenia, contrasenia2;
...
function guardar() {
    ...
    var nombre, apellido,correo,tipoCuenta, genero, telefono, usuario, contrasenia;
    ...
    genero = document.getElementById("comboboxGenero").value;
    correo = document.getElementById("form-email").value;
    tipoCuenta = document.getElementById("comboboxTipoCuenta").value;
